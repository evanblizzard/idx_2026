...
if token:
    ...
    params = {
        ...
        '$filter': f"ListingContractDate ge {datetime(2026, 5, 1).isoformat(timespec='milliseconds')}Z and ListingContractDate lt {datetime(2026, 3, 1).isoformat(timespec='milliseconds')}Z",
